...
const styles = StyleSheet.create({
  ...
  input: { backgroundColor: Colors.bg, borderWidth: 1, borderColor: Colors.border, borderRadius: 12, paddingHorizontal: 14, paddingVertical: 12, fontSize: 14, color: Colors.text, minHeight: 44 },
  inputText: { fontSize: 14, color: Colors.text },
  placeholderText: { fontSize: 14, color: Colors.textMuted },
  textArea: { minHeight: 80, textAlignVertical: 'top', paddingTop: 12 },
  dropdownBtn: { backgroundColor: Colors.bg, borderWidth: 1, borderColor: Colors.border, borderRadius: 12, paddingHorizontal: 14, paddingVertical: 12, minHeight: 44, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
  dropdownChevron: { fontSize: 12, color: Colors.textMuted, marginLeft: 8 },
  pickerList: { marginTop: 4, backgroundColor: Colors.bg, borderRadius: 12, borderWidth: 1, borderColor: Colors.border, overflow: 'hidden' },
