...
const styles = StyleSheet.create({
  ...
  progressBar: { height: 3, backgroundColor: Colors.surfaceHover, marginBottom: 10, borderRadius: 2, overflow: 'hidden' },
  progressFill: { height: '100%', backgroundColor: Colors.accentOrange, borderRadius: 2 },
