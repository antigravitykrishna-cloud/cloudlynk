...
const styles = StyleSheet.create({
  ...
  heroBack: { position: 'absolute', left: 16, zIndex: 10, width: 44, height: 44, alignItems: 'center', justifyContent: 'center', backgroundColor: 'rgba(0,0,0,0.5)', borderRadius: 22 },
  ...
  heroPlayBtn: { flex: 1, backgroundColor: '#fff', borderRadius: 8, paddingVertical: 10, alignItems: 'center' },
  heroPlayTxt: { color: '#000', fontSize: 15, fontWeight: '800' },
  heroInfoBtn: { flex: 1, backgroundColor: 'rgba(255,255,255,0.2)', borderRadius: 8, paddingVertical: 10, alignItems: 'center' },
  heroInfoTxt: { color: '#fff', fontSize: 15, fontWeight: '700' },
  joinBtn: { backgroundColor: Colors.brand, borderRadius: 8, paddingVertical: 10, alignItems: 'center', marginTop: 4 },
  ...
  addBtn: { borderWidth: 1.5, borderColor: Colors.brand, borderRadius: 8, paddingVertical: 10, alignItems: 'center', borderStyle: 'dashed' },
  addBtnTxt: { color: Colors.brand, fontSize: 14, fontWeight: '800' },
  queueBtn: { borderWidth: 1, borderColor: Colors.accentOrange, borderRadius: 8, paddingVertical: 10, alignItems: 'center', backgroundColor: Colors.accentOrangeDim },
  ...
  card: { width: CARD_W },
  cardThumb: { width: CARD_W, height: CARD_H, borderRadius: 8, overflow: 'hidden', backgroundColor: Colors.card, marginBottom: 6, position: 'relative', borderWidth: 0.5, borderColor: Colors.border },
  ...
  cardTypeBadge: { position: 'absolute', top: 6, left: 6, paddingHorizontal: 6, paddingVertical: 2, borderRadius: 4 },
  ...
  createLabel: { fontSize: 11, fontWeight: '800', color: '#31425F', letterSpacing: 1.2, marginBottom: 8, marginTop: 16 },
  ...
  typeChipTxt: { fontSize: 11, color: '#9FB0C9', fontWeight: '700' },
  ...
  videoPicker: { backgroundColor: '#182437', borderRadius: 12, borderWidth: 0.5, borderColor: '#22304A', padding: 20, alignItems: 'center', marginBottom: 4 },
  ...
  progressBar: { height: 4, backgroundColor: '#182437', borderRadius: 4, overflow: 'hidden', marginBottom: 6 },
  progressFill: { height: '100%', backgroundColor: '#2E7DFF', borderRadius: 4 },
  ...
  lockedBanner: { flexDirection: 'row', alignItems: 'center', gap: 12, marginHorizontal: 16, marginTop: 16, backgroundColor: '#111', borderRadius: 12, borderWidth: 0.5, borderColor: '#22304A', padding: 14 },
